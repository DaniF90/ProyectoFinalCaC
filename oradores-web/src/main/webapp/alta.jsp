            ...
            <div class="container">
                <section class="border border-primary rounded-4 col-6 mx-auto text-center" style="background-color: aquamarine">
                    ...
                    <form method="post"
                        ...
                        <div class="my-3 mx-3">
                          <input name="edad" type="number" class="form-control" id="edadNumber" placeholder="Edad" maxlength="3">
                        </div>
                        <div class="my-3 mx-3">
                          <input name="email" type="text" class="form-control" id="emailTextarea" maxlength="50" placeholder="email">
                        </div>
